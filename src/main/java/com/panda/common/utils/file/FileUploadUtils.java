package com.panda.common.utils.file;

import com.panda.common.exception.file.FileNameLengthLimitExceededException;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = PandaConfig.getProfile();
