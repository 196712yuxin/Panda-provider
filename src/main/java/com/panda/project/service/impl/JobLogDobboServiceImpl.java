...
import com.panda.project.monitor.job.mapper.JobLogMapper;
import com.panda.project.service.IJobLogDubboService;
...
public class JobLogDobboServiceImpl implements IJobLogDubboService
{
    @Autowired
